...
namespace MAVN.Service.Referral.MsSqlRepositories.Migrations
{
    ...
    [Migration("20190704140922_AddPhoneCountryCodeAndName")]
    partial class AddPhoneCountryCodeAndName
    {
            ...
            modelBuilder.Entity("Lykke.Service.Referral.MsSqlRepositories.Entities.ReferralLeadEntity", b =>
                {
                    ...
                    b.Property<string>("PhoneCountryName")
                        .HasColumnName("phone_country_name")
